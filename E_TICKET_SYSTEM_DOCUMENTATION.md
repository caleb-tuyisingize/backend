...
```json
{
  ...
  "verificationUrl": "https://backend-7cxc.onrender.com/api/tickets/verify/ticket-id"
}
```
...
APP_URL=https://backend-7cxc.onrender.com
...
```bash
# Using curl
curl https://backend-7cxc.onrender.com/api/tickets/verify/BK-2026-ABC123

# Using browser
https://backend-7cxc.onrender.com/api/tickets/verify/your-booking-ref
```
...
- Test verification: `curl https://backend-7cxc.onrender.com/api/tickets/verify/test`
